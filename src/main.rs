...
fn main() -> Result<(), std::io::Error> {
    ...
    app.insert_resource(cr)
        ...
        .insert_resource(bevy::winit::WinitSettings {
            focused_mode: bevy::winit::UpdateMode::ReactiveLowPower { max_wait: Duration::from_secs(5) },
            unfocused_mode: bevy::winit::UpdateMode::ReactiveLowPower { max_wait: Duration::from_secs(90) },
